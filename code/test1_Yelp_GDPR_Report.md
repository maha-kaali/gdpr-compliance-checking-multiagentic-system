...
_Notes:_ The policy mentions data collection, use, and storage, and includes some specific examples of data collected (name, email, address, etc.). However, it does not explicitly address the principles of lawfulness, fairness, transparency, accuracy, storage limitation, or accountability in sufficient detail. While purpose limitation and data minimisation are implicitly covered by the stated uses of the data, they are not explicitly detailed as per the GDPR principles.
...
_Notes:_ The policy mentions that 'When you use the Service, you consent to our collection, use, and disclosure of information about you as described in this Privacy Policy.' However, it does not explicitly detail the conditions for consent as required by GDPR Article 7, such as whether consent is freely given, specific, informed, and unambiguous. Additionally, the mechanism for withdrawing consent is not described, nor is it clarified if consent is a condition for service provision. Therefore, the status is partial due to missing explicit information regarding these GDPR requirements.
...
_Notes:_ The policy mentions translating the privacy policy for convenience, and that some messages may be sent via automated SMS text messages, but does not explicitly cover the 'plain language', 'electronic means' for response, or 'free of charge' requirements of Article 12(1) and 12(5) respectively. Additionally, the policy does not detail the 1-month response commitment from Article 12(3).
...
* Data subject rights summary (access, rectification, erasure, restriction, objection, portability, withdrawal of consent, lodging a complaint)
* Whether data provision is statutory/contractual and consequences of failure
* Existence and logic of automated decision-making/profiling

_Notes:_ The policy provides information on the identity of the controller(s) (Yelp Inc. or Yelp Ireland Ltd. based on residency) and their headquarters/establishment location. However, specific contact details for the controller and DPO are missing. The purposes of processing are listed, but the legal basis is not explicitly stated. Retention periods are not mentioned, nor are the recipients of personal data. Information about data subject rights, whether data provision is mandatory, and details on automated decision-making/profiling are also absent.
...
_Notes:_ The policy mentions that information may be shared with third parties and that third parties may share information with the company. However, it does not specify the source of data when it is not obtained directly from the data subject, nor does it address automated decision-making, profiling, or the logic involved. This leads to a partial compliance status.
...
_Notes:_ The policy mentions that identity verification steps will be taken before sharing personal data, and that European residents have the right to access their personal data. However, it does not specify the response timeline (e.g., one month) or what specific information will be provided in response to a Subject Access Request (SAR), nor does it explicitly state that a copy of the personal data will be provided.
...
_Notes:_ The policy confirms the right to deletion for European residents and directs users to the Support Center for more information. However, it does not detail the process for making such a request, the grounds for refusal, or any exceptions to deletion, which are required by Article 17.
...
_Notes:_ The policy mentions that Yelp collects, transmits, and stores information about users. However, it does not explicitly state that this data is provided in a structured, commonly used, and machine-readable format, nor does it mention the right to transmit this data to another controller without hindrance. The policy also does not clarify whether the processing is carried out by automated means, which is a condition for the right to data portability under GDPR Article 20(1)(b).
...
_Notes:_ The policy mentions that users can opt-in to receive messages and manage some preferences, but it does not explicitly detail the right to object to direct marketing or profiling, nor does it specify if this objection can be made via automated means as required by GDPR Article 21.
...
_Notes:_ The policy mentions automated SMS text messages for transactions, but there is no information regarding decisions based solely on automated processing, including profiling, that produce legal or similarly significant effects. There is also no mention of the right to human intervention, to express a point of view, or to contest such decisions. Therefore, the company policy does not address the requirements of GDPR Article 22.
...
_Notes:_ The policy mentions taking steps to safeguard information and ensuring an adequate level of data protection, which implies the implementation of measures. However, it does not explicitly state the obligation to implement appropriate technical and organisational measures to ensure and demonstrate compliance, nor does it mention the implementation of data protection policies or adherence to codes of conduct/certification mechanisms as per Article 24.
...
* There is no explicit mention of processing personal data only on written instructions from the controller.

_Notes:_ The policy lacks specific clauses required by Article 28 of GDPR, particularly regarding sub-processors, audit rights, data deletion/return, and processing based on written instructions. The provided text focuses on data collection and usage for service provision and communication, not on the contractual obligations between a controller and processor.
...
_Notes:_ The policy mentions collection and storage of various data points, and sharing with third parties, but does not explicitly detail the purposes of processing, categories of data subjects and data, recipients, retention periods, or security measures in a structured manner as required by Article 30. The information about "legal basis" for European residents does not fulfill the requirement for a Record of Processing Activities (ROPA).
...
* The policy does not provide contact details for a Data Protection Officer.

_Notes:_ The provided policy text does not contain information regarding the designation of a Data Protection Officer (DPO) as required by GDPR Article 37. Specifically, it does not address whether the company's activities fall under the criteria for mandatory DPO designation (public authority, large-scale monitoring, or processing special categories of data). Furthermore, the contact details of a DPO are not published. Therefore, the status is partial, and the risk is high due to the lack of information on a critical GDPR compliance aspect.
...
_Notes:_ The policy does not contain any information regarding international data transfers or the mechanisms used to ensure the adequacy of protection for such transfers. Therefore, compliance with Article 45 cannot be verified.
...
_Notes:_ The policy does not mention the right to lodge a complaint with a supervisory authority or how to do so. This is a high-risk gap as it directly relates to a data subject's fundamental rights under GDPR.
...
_Notes:_ The provided policy text does not contain any information related to the processing of employee data in the employment context, such as recruitment, monitoring, health and safety, or termination. Therefore, it is not possible to assess compliance with Article 88.
...
- Type: p3_verify
- Notes: The policy explicitly states it is not directed to children under 13 and does not knowingly collect personal information from them, but it does not contain language regarding parental consent mechanisms or specific age thresholds for consent, which is the core of Article 8.

**2. Article 10: Criminal convictions data**
- Type: p3_verify
- Notes: The policy does not mention criminal convictions data or any related concepts.

**3. Article 19: Notification on rectification/erasure**
- Type: p3_verify
- Notes: The policy excerpt does not contain information regarding the notification of recipients upon rectification or erasure of personal data. The provided chunks and full excerpt focus on data collection, usage, security, and user rights, but lack specifics on downstream notifications to third parties or other recipients.
...
- Type: p3_verify
- Notes: The policy does not mention joint controllers or agreements between controllers.

**6. Article 27: Representatives (non-EU)**
- Type: p3_verify
- Notes: The policy mentions Yelp Inc. is a Delaware corporation with headquarters in San Francisco, California, and Yelp Ireland Ltd. for European Residents. This implies the company operates in the EU but does not explicitly address the appointment of a non-EU representative as required by Article 27.

**7. Article 32: Security of processing**
- Type: p3_verify
- Notes: The policy mentions safeguards and security but does not detail specific measures like encryption or access controls. It also lacks mention of incident response or testing. Therefore, while the topic is present, the operational details requested by the agent action are absent.

**8. Article 33: Breach notification to SA**
- Type: p3_verify
- Notes: The policy does not contain information regarding breach notification procedures to a supervisory authority or the establishment of a 72-hour timeline for such notifications. It also does not mention operational breach logs or their review by humans.

**9. Article 34: Breach communication to data subject**
- Type: p3_verify
- Notes: The policy does not contain information about procedures for communicating data breaches to data subjects, as required by GDPR Article 34.

**10. Article 35: DPIA**
- Type: p3_verify
- Notes: The policy does not mention Data Protection Impact Assessments (DPIAs) or similar risk assessment procedures related to high-risk processing activities as required by Article 35 of the GDPR. The policy focuses on data collection, use, disclosure, and user rights, but does not include any provisions for conducting DPIAs.

**11. Article 38: DPO position**
- Type: p3_verify
- Notes: The policy does not mention the appointment, role, or position of a Data Protection Officer (DPO) or any specific language regarding their independence. Therefore, Article 38 is not addressed.

**12. Article 40: Codes of conduct**
- Type: p3_verify
- Notes: The provided policy text does not contain any mention or discussion of codes of conduct, adherence to codes of conduct, or any regulatory approval processes related to such codes. Article 40 of the GDPR pertains to these specific topics, which are absent in the given Yelp privacy policy.

**13. Article 42: Certification**
- Type: p3_verify
- Notes: The policy does not mention certifications or claims related to them. It does mention professional licenses or certifications in the context of professional background information for businesses, but this is not related to the GDPR Article 42 topic of data protection certification.
...
- Type: p3_verify
- Notes: The policy does not mention Binding Corporate Rules (BCR) or any related concepts like DPA approval for such rules. The provided text focuses on general privacy policies, data collection, use, and disclosure, user rights, and compliance with laws like CCPA and Nevada law.
